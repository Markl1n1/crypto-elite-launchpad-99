export const ru = {
  ...
  whereLocatedA: 'Наш главный офис находится в Лос-Анджелесе, Калифорния, а члены команды работают по всему миру: Швейцария, Германия, Великобритания, Китай, Канада, Испания, Польша, Эстония.',
  ...
  qualificationA: 'Мы работаем с серьезными инвесторами, которые имеют минимум $10,000 для инвестирования и привержены долгосрочному накоплению капитала. Однако в течении года появляются возможности начать даже с минимальным капиталом.',
  ...
  cookieDetails: 'Подробности о файлах cookie',
  acceptAllCookies: 'Принять все',
  ...
  analyticsCookiesDesc: 'Эти файлы cookie помогают нам понять, как посетители взаимодействуют с нашим веб-сайте, собирая и сообщая информацию анонимно.',
