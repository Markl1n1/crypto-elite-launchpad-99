...
const notifications: Notification[] = [
  ...
  { id: '43', name: 'Xavier Dubois-Moreau', countryCode: 'BE', country: 'Belgium' },
  ...
  { id: '48', name: 'Yuki Hashimoto-Suzuki', countryCode: 'JP', country: 'Japan' },
  { id: '49', name: 'Eszter Nagy-Kovács', countryCode: 'HU', country: 'Hungary' },
  { id: '50', name: 'Gabriel Mendoza-Vargas', countryCode: 'CO', country: 'Colombia' },
  ...
  { id: '56', name: 'Magnus Pedersen-Sørensen', countryCode: 'DK', country: 'Denmark' },
  { id: '57', name: 'Zara Okafor-Emeka', countryCode: 'NG', country: 'Nigeria' },
  { id: '58', name: 'Viktor Novák-Horváth', countryCode: 'SK', country: 'Slovakia' },
