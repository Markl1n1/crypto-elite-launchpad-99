...
export const Testimonials = ({ scrollToSection }: TestimonialsProps) => {
  ...
  const testimonials = [
    ...
    {
      name: 'Michael R.',
      profession: t('automotiveRetailer'),
    ...
    {
      name: 'David K.',
      profession: t('systemAdministrator'),
    ...
    {
      name: 'Carlos M.',
      profession: t('highSchoolTeacher'),
    ...
    {
      name: 'Tomasz B.',
      profession: t('professionalBroker'),
    ...
    <section id="testimonials" className="py-14">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8 md:mb-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6">{t('whatOurUsersSay')}</h2>
